...
namespace SuccincT.PatternMatchers
{
...

    {
        ...
        IActionWithHandler<IActionMatcher<T1, T2, T3>, T1, T2, T3> IMatcher<T1, T2, T3>.With(
        ...
        IFuncWithHandler<IFuncMatcher<T1, T2, T3, TResult>, T1, T2, T3, TResult>
            IFuncWithHandler<IFuncMatcher<T1, T2, T3, TResult>, T1, T2, T3, TResult>.Or(
                Either<T1, Any> value1,
                Either<T2, Any> value2,
                Either<T3, Any> value3)
        {
        ...
        private void RecordFunction(
            Func<(T1, T2, T3), IList<EitherTuple<T1, T2, T3>>, bool> test,
        ...
        IActionWithHandler<IActionMatcher<T1, T2, T3>, T1, T2, T3>
            IActionWithHandler<IActionMatcher<T1, T2, T3>, T1, T2, T3>.Or(
                Either<T1, Any> value1,
                Either<T2, Any> value2,
                Either<T3, Any> value3)
        {
