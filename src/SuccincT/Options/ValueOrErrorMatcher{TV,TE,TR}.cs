...
{
    internal sealed class ValueOrErrorMatcher<TValue, TError, TResult> : IUnionFuncPatternMatcherAfterElse<TResult>, IValueOrErrorFuncMatcher<TValue, TError, TResult>, IValueOrErrorActionMatcher<TValue, TError>, IUnionActionPatternMatcherAfterElse
    {
        ...
        IUnionFuncPatternCaseHandler<IValueOrErrorFuncMatcher<TValue, TError, TResult>, TValue, TResult>
            IValueOrErrorFuncMatcher<TValue, TError, TResult>.Value() =>
                new UnionPatternCaseHandler<IValueOrErrorFuncMatcher<TValue, TError, TResult>, TValue, TResult>(RecordValueAction, this);
        ...
        IUnionFuncPatternCaseHandler<IValueOrErrorFuncMatcher<TValue, TError, TResult>, TError, TResult>
            IValueOrErrorFuncMatcher<TValue, TError, TResult>.Error() =>
                new UnionPatternCaseHandler<IValueOrErrorFuncMatcher<TValue, TError, TResult>, TError, TResult>(RecordErrorAction, this);
        ...
        IUnionActionPatternCaseHandler<IValueOrErrorActionMatcher<TValue, TError>, TValue> IValueOrErrorActionMatcher<TValue, TError>.Value() =>
                new UnionPatternCaseHandler<IValueOrErrorActionMatcher<TValue, TError>, TValue, TResult>(RecordValueAction, this);

        IUnionActionPatternCaseHandler<IValueOrErrorActionMatcher<TValue, TError>, TError> IValueOrErrorActionMatcher<TValue, TError>.Error() =>
                new UnionPatternCaseHandler<IValueOrErrorActionMatcher<TValue, TError>, TError, TResult>(RecordErrorAction, this);

        IUnionActionPatternMatcherAfterElse IValueOrErrorActionMatcher<TValue, TError>.Else(Action<ValueOrError<TValue, TError>> elseAction)
        {
