    ...
    public static class UnionOf4ConverterTests
    {
        ...
        public static void WhenProvidedWithNoCase_DeserializeFailsWithJsonException()
        {
            ...
            _ = Throws<JsonException>(() => {
                _ = DeserializeObject<Union<int, List<int>, string, List<string>>>("{k:1, value:2}", settings);
            });
        }
        ...
        public static void WhenProvidedWithNoValue_DeserializeFailsWithJsonException()
        {
            ...
            _ = Throws<JsonException>(() => {
                _ = DeserializeObject<Union<int, List<int>, string, List<string>>>("{case:\"Case1\", k:2}", settings);
            });
        }
