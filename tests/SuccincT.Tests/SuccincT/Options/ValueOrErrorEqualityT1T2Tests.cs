...
{
    [TestFixture]
    public class ValueOrErrorEqualityT1T2Tests
    {
        [Test]
        ...
        [Test]
        public void ComparingNullErrorWithAnotherNullError_ResultsInEqual()
        {
        ...
        [Test]
        public void ComparingNullValueWithAnotherNullValue_ResultsInEqual()
        {
        ...
        [Test]
        public void ComparingNullValueWithNullError_ResultsInNotEqual()
        {
            var a = WithValue(null);
            var b = WithError(null);
            IsFalse(a.Equals(b));
