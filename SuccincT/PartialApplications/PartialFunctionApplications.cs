...
namespace SuccincT.PartialApplications
{
    ...
    public static class PartialFunctionApplications
    {
        ...
        public static Func<T2, TResult>
            Apply<T1, T2, TResult>(this Func<T1, T2, TResult> functionToApply, T1 p1)
        {
            return p2 => functionToApply(p1, p2);
        }
        ...
        {
            return (p2, p3) => functionToApply(p1, p2, p3);
        }
        ...
        public static Func<T3, TResult>
            Apply<T1, T2, T3, TResult>(this Func<T1, T2, T3, TResult> functionToApply, T1 p1, T2 p2)
        {
            return p3 => functionToApply(p1, p2, p3);
        }
        ...
        {
            return (p2, p3, p4) => functionToApply(p1, p2, p3, p4);
        }
        ...
        {
            return (p3, p4) => functionToApply(p1, p2, p3, p4);
        }
        ...
        {
            return p4 => functionToApply(p1, p2, p3, p4);
        }
        ...
        public static Func<T2, T3, T4, T5, TResult>
            Apply<T1, T2, T3, T4, T5, TResult>(this Func<T1, T2, T3, T4, T5, TResult> functionToApply,
                                                 T1 p1)
        {
            return (p2, p3, p4, p5) => functionToApply(p1, p2, p3, p4, p5);
        }
        ...
        public static Func<T3, T4, T5, TResult>
            Apply<T1, T2, T3, T4, T5, TResult>(this Func<T1, T2, T3, T4, T5, TResult> functionToApply,
                                                 ...
                                                 T2 p2)
        {
            return (p3, p4, p5) => functionToApply(p1, p2, p3, p4, p5);
        }
        ...
        public static Func<T4, T5, TResult>
            Apply<T1, T2, T3, T4, T5, TResult>(this Func<T1, T2, T3, T4, T5, TResult> functionToApply,
                                                 ...
                                                 T3 p3)
        {
            return (p4, p5) => functionToApply(p1, p2, p3, p4, p5);
        }
        ...
        public static Func<T5, TResult>
            Apply<T1, T2, T3, T4, T5, TResult>(this Func<T1, T2, T3, T4, T5, TResult> functionToApply,
                                                 ...
                                                 T4 p4)
        {
            return p5 => functionToApply(p1, p2, p3, p4, p5);
        }
        ...
        public static Func<T2, T3, T4, T5, T6, TResult>
            Apply<T1, T2, T3, T4, T5, T6, TResult>(this Func<T1, T2, T3, T4, T5, T6, TResult> functionToApply,
                                                     T1 p1)
        {
            return (p2, p3, p4, p5, p6) => functionToApply(p1, p2, p3, p4, p5, p6);
        }
        ...
        public static Func<T3, T4, T5, T6, TResult>
            Apply<T1, T2, T3, T4, T5, T6, TResult>(this Func<T1, T2, T3, T4, T5, T6, TResult> functionToApply,
                                                     ...
                                                     T2 p2)
        {
            return (p3, p4, p5, p6) => functionToApply(p1, p2, p3, p4, p5, p6);
        }
        ...
        public static Func<T4, T5, T6, TResult>
            Apply<T1, T2, T3, T4, T5, T6, TResult>(this Func<T1, T2, T3, T4, T5, T6, TResult> functionToApply,
                                                     ...
                                                     T3 p3)
        {
            return (p4, p5, p6) => functionToApply(p1, p2, p3, p4, p5, p6);
        }
        ...
        public static Func<T5, T6, TResult>
            Apply<T1, T2, T3, T4, T5, T6, TResult>(this Func<T1, T2, T3, T4, T5, T6, TResult> functionToApply,
                                                     ...
                                                     T4 p4)
        {
            return (p5, p6) => functionToApply(p1, p2, p3, p4, p5, p6);
        }
        ...
        public static Func<T6, TResult>
            Apply<T1, T2, T3, T4, T5, T6, TResult>(this Func<T1, T2, T3, T4, T5, T6, TResult> functionToApply,
                                                     ...
                                                     T5 p5)
        {
            return p6 => functionToApply(p1, p2, p3, p4, p5, p6);
        }
    }
}