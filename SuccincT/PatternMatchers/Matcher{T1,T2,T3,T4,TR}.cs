...
namespace SuccincT.PatternMatchers
{
    ...
    {
        private readonly MatchFunctionSelector<Tuple<T1, T2, T3, T4>, TResult> _functionSelector;
        ...
        {
            _item = item;
            _functionSelector = new MatchFunctionSelector<Tuple<T1, T2, T3, T4>, TResult>(x =>
            {
