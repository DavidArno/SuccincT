...
{
    public sealed class OptionMatcher2<T, TReturn>
    {
        ...
        internal OptionMatcher2(Option<T> option)
        {
            _option = option;
        }

        public OptionMatcher2<T, TReturn> Some(Func<T, TReturn> action)
        {
            _someAction = action;
            return this;
        }

        public OptionMatcher2<T, TReturn> Some(Action<T> action)
        {
        ...
        public OptionMatcher2<T, TReturn> Some(T value, Func<T, TReturn> func)
        {
            AddMatchExpressions(new List<Func<T, bool>> { x => EqualityComparer<T>.Default.Equals(x, value) }, func);
            return this;
        }

        public OptionMatcher2<T, TReturn> Some(T value, Action<T> action)
        {
        ...
        public OptionMatcher2<T, TReturn> When(Func<T, bool> testExpression, Func<T, TReturn> action)
        {
            AddMatchExpressions(new List<Func<T, bool>> { testExpression }, action);
            return this;
        }

        public OptionMatcher2<T, TReturn> When(Func<T, bool> testExpression, Action<T> action)
        {
        ...
        public OptionMatcher2<T, TReturn> None(Func<TReturn> action)
        {
            _noneAction = action;
            return this;
        }

        public OptionMatcher2<T, TReturn> None(Action action)
        {
