...
namespace SuccincT.Functional
{
    ...
    /// </summary>
    public delegate void ActionWithOptionalParameter<in T1, in T2>(T1 p1, T2 p2 = default(T2));

    /// <summary>
    /// Action{T1, T2, T3} equivalant delegate for when T3 is an optional parameter
    /// </summary>
    public delegate void ActionWithOptionalParameter<in T1, in T2, in T3>(T1 p1, T2 p2, T3 p3 = default(T3));

    /// <summary>
    /// Action{T1, T2, T3, T4} equivalant delegate for when T4 is an optional parameter
    /// </summary>
    public delegate void ActionWithOptionalParameter<in T1, in T2, in T3, in T4>
        (T1 p1, T2 p2, T3 p3, T4 p4 = default(T4));
    ...
    public delegate void ActionWithOptionalParameter<in T1, in T2, in T3, in T4, in T5>
        (T1 p1, T2 p2, T3 p3, T4 p4, T5 p5 = default(T5));
