...
namespace SuccincTTests.SuccincT.Functional
{
    ...
    public class ActionExtensionsTests
    {
        ...
        {
            var value = 1;
            var func = Lambda(() => { value = 2; }).ToUnitFunc();
            var result = func();
        ...
        {
            var value = 1;
            var func = Lambda<int>(x => { value = x; }).ToUnitFunc();
            var result = func(3);
        ...
        {
            var value = 1;
            var func = Lambda<int, int>((x, y) => { value = x + y; }).ToUnitFunc();
            var result = func(3, 2);
        ...
        {
            var value = 1;
            var func = Lambda<int, int, int>((x, y, z) => { value = x * y + z; }).ToUnitFunc();
        ...
        {
            var value = 1;
            var func = Lambda<int, int, int, int>((w, x, y, z) => { value = (w + x) * (y + z); }).ToUnitFunc();
        ...
        [Test]
        public void ConvertingFuncToAction_AllowsActionToBeRun()
        {
            var value = 1;
            var func = Lambda(() => { value = 2; }).ToUnitFunc();
            var result = func();
